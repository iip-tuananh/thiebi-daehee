               ...
               <ul class="header-nav header-nav-main nav nav-left  nav-uppercase" >
                  <li class="header-block">
                     <div class="header-block-block-1">
                        <div class="row row-small contact-header"  id="row-295577222">
                           <div id="col-1912678426" class="col medium-6 small-12 large-6"  >
                              <div class="col-inner"  >
                                 <div class="icon-box featured-box icon-box-left text-left"  >
                                    <div class="icon-box-img" style="width: 45px">
                                       <div class="icon">
                                          <div class="icon-inner icon-home" >
                                             <i class="fa-solid fa-house "></i>		
                                          </div>
                                       </div>
                                    </div>
                                    <div class="icon-box-text last-reset">
                                       <p><span style="color: #000080;" class="cusor-pointer"><strong>{{$setting ->address1}}</strong></span></p>
                                    </div>
                                 </div>
                              </div>
                           </div>
                           <div id="col-83088684" class="col medium-6 small-12 large-6"  >
                              <div class="col-inner"  >
                                 <div class="icon-box featured-box icon-box-left text-left"  >
                                    <div class="icon-box-img" style="width: 45px">
                                       <div class="icon icon-home-phone">
                                          <i class="fa-solid fa-square-phone"></i>
                                       </div>
                                    </div>
                                    <div class="icon-box-text last-reset">
                                       <p style="">Kỹ thuật: <span style="color: #003366;"><strong>{{$setting ->phone1}}</strong></span></p>
                                       <a href=""></a>
                                       <p>Kinh doanh: <span style="color: #003366;"><strong>{{ $setting ->phone2}}</strong></span></p>
                                    </div>
                                 </div>
                              </div>
                           </div>
                        ...
                        <div class="cart-popup-inner inner-padding">
                            <div class="cart-popup-inner inner-padding">
                                ...
                                <div class="widget_shopping_cart_content">
                                   ...
                                   <p class="woocommerce-mini-cart__buttons buttons"><a href="{{route('listCart')}}" class="button wc-forward wp-element-button">Xem giỏ hàng</a>
                                    <a href="{{route('checkout')}}" class="button checkout wc-forward wp-element-button">Thanh toán</a></p>
                                </div>
                              ...
                              <div class="cart-page d-none">
                                 <div class="drawer__inner">
                                    <div class="CartPageContainer">
                                       <div class="cart--empty-message transform-100 " style="text-align: center">
                                          <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" height="50px" width="50px" viewBox="0 0 201.387 201.387" style="enable-background:new 0 0 201.387 201.387;" xml:space="preserve">
                                             <g>
                                                <g>

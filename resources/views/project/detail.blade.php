...
<main id="main" class="">
    @php
          $imgs =json_decode($blog_detail->images);
    @endphp
         ...
         <div class="large-9 col">
            <article id="post-7595" class="post-7595 post type-post status-publish format-standard has-post-thumbnail hentry category-tin-tuc">
               <div class="article-inner ">
                     ...
                     <img width="851" height="478" src="{{$imgs[0]}}" class="attachment-large size-large wp-post-image" alt="he thong giu xe thong minh toi uu hoat dong cua bai giu" decoding="async" srcset="{{$imgs[0]}} " sizes="(max-width: 851px) 100vw, 851px" title="{{$blog_detail->name}}">

...
<div class="header-popcart " >
    <div class="top-cart-header">
        <span>
            ...
            Bạn đã thêm [<a class="cart-popup-name" href="/cu-sac-nhanh-aukey-pa-f1s-20w-usb-c-pd">{{languageName($cartItemName)}}</a>] vào giỏ hàng
        </span>
    </div>
            ...
            <div class="ajaxcart__row data-update-cart" data-url="{{route('updateCart')}}">
                ...
                @endphp
                    <div class="ajaxcart__product cart_product" data-line="1">
                        <a href="/cu-sac-nhanh-aukey-pa-f1s-20w-usb-c-pd" class="ajaxcart__product-image cart_image" title="{{languageName($item['name'])}}"><img width="80" height="80" src="{{$item['image']}}" alt="{{languageName($item['name'])}}"></a>
                        <div class="grid__item cart_info">
                            <div class="ajaxcart__product-name-wrapper cart_name">
                                <a href="/cu-sac-nhanh-aukey-pa-f1s-20w-usb-c-pd" class="ajaxcart__product-name h4" title="{{languageName($item['name'])}}">{{languageName($item['name'])}}</a>
                                @if(($item['color']) != '')
